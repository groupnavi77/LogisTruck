    ...
    <div class="row">
      ...
      <div class="col-sm-10 main">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Viajes por chofer</li>
        </ol>


        <div class="panel panel-primary">
         <div class="panel-heading">Viajes del chofer <?php echo" [$idEmpleado], entre ($fechaViajeDesde) y ($fechaViajeHasta):"; ?></div>
         <div class="container-fluid">
          <div class="row">
            <div class="table-responsive" id="tabla">
              <table class="table table-hover">
               ...
               <tbody  class="text-center">
                ...
                WHERE choferesdelviaje.idEmpleado = '$idEmpleado' AND viaje.fechaViaje BETWEEN '$fechaViajeDesde' AND '$fechaViajeHasta'"; 
