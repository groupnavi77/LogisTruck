...
$idEstadoViajeNuevo = 3; // con 3 EL VIAJE PASA A "FINALIZADO"
...
if ($idEmpleadoLogueado == $idEmpleadoViaje AND $idEstadoViajeActual == 2) // si id del empleado logueado es = al empleado asignado en ese viaje hago el update, y el estado del viaje tiene que ser (2)EN CURSO
{
